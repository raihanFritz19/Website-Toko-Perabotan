    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Cahaya Perabotan</a>
            </div>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li class="text-center">
                        <img src="assets/img/LogoTokoCahaya.png" class="user-image img-responsive"/>
                    </li>
                    ...
                    <li><a href="index.php?halaman=pembelian"><i class="fa fa-shopping-cart"></i> Penjualan</a></li>
